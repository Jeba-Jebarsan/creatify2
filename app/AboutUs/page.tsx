          ...
          <article className='bg-white text-gray-900 shadow-2xl rounded-lg p-6 lg:p-12 border border-gray-300'>
            ...
            <section className='mb-8'>
              <p className='text-lg leading-relaxed'>
                Welcome to CreaivyAI, the cutting-edge AI-powered tool designed to revolutionize the way you create and manage content. At  CreaivyAI, our mission is to empower individuals and businesses with advanced tools that streamline content creation, enhance productivity, and drive innovation.
              </p>
            </section>
            <section className='mb-8'>
            ...
            <section>
              ...
              <p className='text-lg font-semibold text-gray-900 mt-4'>
                Thank you! for choosing  CreaivyAI. We look forward to being part of your creative journey and helping you achieve your content goals!
              </p>
            </section>
          </article>
        </div>
