  ...
  const caseStudies = [
    {
      ...
      solution: ' CreaivyAI provided a comprehensive suite of tools for generating blog titles, content ideas, social media posts, and email campaigns, significantly reducing the time spent on content creation.',
      results: [
      ...
      testimonial: ' CreaivyAI has transformed how we approach content creation, allowing us to focus more on strategy and less on production. — Digital Marketing Director',
    },
    {
      ...
      solution: ' CreaivyAI’s features for generating product descriptions and SEO-friendly content allowed the company to improve its search rankings and better engage with customers.',
      results: [
      ...
      testimonial: 'Thanks to  CreaivyAI, our content is now not only high-quality but also optimized for search engines, leading to noticeable improvements in our sales. — E-commerce Manager',
    },
    {
      ...
      solution: ' CreaivyAI offered tools for generating ideas, improving grammar, and crafting SEO titles and descriptions, enabling the creator to maintain a steady stream of high-quality content.',
      results: [
      ...
      testimonial: ' CreaivyAI is like having a personal assistant that helps me stay ahead in the content game. It\'s been a game-changer for my growth. — Content Creator',
    },
  ];
  ...
  return (
    <div className='bg-gradient-to-r bg-blue-950 text-white min-h-screen py-8 px-4 lg:px-8'>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '28px', marginBottom: '10px' }}>Real Success Stories with  CreaivyAI</h2>
        <p>Discover how  CreaivyAI has helped businesses and individuals transform their content creation process. Explore detailed case studies that showcase our tool’s impact across various industries and use cases.</p>
      </section>
      ...
      <section style={{ textAlign: 'center', marginTop: '40px' }}>
        ...
        <p>Join the ranks of satisfied  CreaivyAI users who have transformed their content creation process. Start your free trial today and see the difference AI can make.</p>
        <button
          style={{
            padding: '10px 20px',
      ...
      <section style={{ textAlign: 'center', marginTop: '40px' }}>
        ...
        <p>We’re here to help you achieve your content goals. Reach out to us for more information or to discuss how  CreaivyAI can benefit your business.</p>
